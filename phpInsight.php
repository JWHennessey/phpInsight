...
class Sentiment{
		...
		private $tokCount = 0; // Token Counter Var
                                ...
                                //Query to select the words for a type of classification
                                 ...
                                 $rows = mysql_num_rows($results);
                                       ...
                                       for($i=0; $i<$rows; ++$i) {
                                                ...
                                                //Add one to the document count variable
                                                $this->docCount++;

                                                //Add one to the cassDocumentCount variable for the class being looped through
                                                ...
                                                //Add one to the token counter for this class
                                                $this->classTokCounts[$class]++;

                                                //Add one to the overall token counter
                                                $this->tokCount++;
			...
			public function _cleanString($string)  //Function to clean a string so all characters with accents are turned into ASCII characters. EG: á = a
			{
				$diac =
